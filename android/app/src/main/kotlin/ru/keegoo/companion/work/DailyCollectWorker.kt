...
class DailyCollectWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        ...
        // TODO: передать snapshot в репозиторий → отправить на бэкенд
        android.util.Log.d("DailyCollect", "snapshot=$snapshot")
    ...
    companion object {
        ...
        fun schedule(context: Context) {
            val request = PeriodicWorkRequestBuilder<DailyCollectWorker>(
                repeatInterval = 12,
